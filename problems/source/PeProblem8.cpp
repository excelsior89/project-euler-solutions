...
// Global problem data, just to save having to define the big array twice
const size_t kWindowSize = 13;
...
#define ProfilingFunc profiling::TimeProfileFunction<PeUint, const vector<PeUint> &, size_t>
...
ostream &PeProblem8::ProfileSolutions(int n_trials, ostream &os)
{
	...
	// Profile each method
	ProfilingFunc(1, n_trials, os, Method1, kNumber, kWindowSize);
	ProfilingFunc(2, n_trials, os, Method2, kNumber, kWindowSize);
	ProfilingFunc(3, n_trials, os, Method3, kNumber, kWindowSize);
