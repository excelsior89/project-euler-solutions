...
#define PROFILE_INPUT_TYPES_ PeUint, tuple<PeUint, PeUint, PeUint> &
#define PROFILE_ARGS_ 1000, tuple<PeUint, PeUint, PeUint>(0, 0, 0)

PROFILE_SOLUTIONS(PeProblem9, Method1, Method2)
