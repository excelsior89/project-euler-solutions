...
ostream &PeProblem11::DisplayProblem(ostream &os)
{
	...
	"32 98 81 28 64 23 67 10 " << formatting::ansi::TextRed << "26" << 
		formatting::ansi::Reset << " 38 40 67 59 54 70 66 18 38 64 70" << endl <<
	"67 26 20 68 02 62 12 20 95 " << formatting::ansi::TextRed << "63" << 
		formatting::ansi::Reset << " 94 39 63 08 40 91 66 49 94 21" << endl <<
	"24 55 58 05 66 73 99 26 97 17 " << formatting::ansi::TextRed << "78" << 
		formatting::ansi::Reset << " 78 96 83 14 88 34 89 63 72" << endl <<
	"21 36 23 09 75 00 76 44 20 45 35 " << formatting::ansi::TextRed << "14" << 
		formatting::ansi::Reset << " 00 61 33 97 34 31 33 95" << endl <<
